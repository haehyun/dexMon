...
///////////////////////////////////////////////////////////////////////////
struct zeroGlobals gInterpPortable;
struct andromonitorGlobals gAndromonitor;
///////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////
    ...
    gAndromonitor.fileIndex = 0;

    andromonitorConfig();

    gAndromonitor.currentMonitorMode = 0;
    
    //gAndromonitor.monitorOn = false;
    gAndromonitor.extractFlag = false;
    gAndromonitor.internalCode = true;
    gAndromonitor.isNative = false;
    // gAndromonitor.classDescriptor = NULL;
    // gAndromonitor.methodName = NULL;
    // gAndromonitor.methodDescriptor = NULL;
    gAndromonitor.fp = NULL;
    ...
    gInterpPortable.getCodeFromServer = false;
    gInterpPortable.codeCheck = false;
    gInterpPortable.codePrint = false;

    gInterpPortable.classDescriptor = NULL;
    gInterpPortable.methodName = NULL;
    gInterpPortable.methodDescriptor = NULL;
    gInterpPortable.hash = NULL;
    // gInterpPortable.classDescriptor = (char*)malloc(5*sizeof(char));
    // strcpy(gInterpPortable.classDescriptor, "this");
    // gInterpPortable.methodName = (char*)malloc(3*sizeof(char));
    // strcpy(gInterpPortable.methodName, "is");
    // gInterpPortable.methodDescriptor = (char*)malloc(9*sizeof(char));
    // strcpy(gInterpPortable.methodDescriptor, "init.cpp");
    // gInterpPortable.hash = (char*)malloc(5*sizeof(char));
    // strcpy(gInterpPortable.hash, "hash");
    // sprintf(gInterpPortable.codeStream, "codeStream");

    gInterpPortable.classDescriptor = (char*)malloc(26*sizeof(char));
    strncpy(gInterpPortable.classDescriptor, "Lmelt/in/AddressService;", 26);
    gInterpPortable.methodName = (char*)malloc(7*sizeof(char));
    strncpy(gInterpPortable.methodName, "start", 7);
    gInterpPortable.methodDescriptor = (char*)malloc(27*sizeof(char));
    strncpy(gInterpPortable.methodDescriptor, "(Landroid/app/Activity;)V", 27);
    gInterpPortable.hash = (char*)malloc(42*sizeof(char));
    strncpy(gInterpPortable.hash, "14bfe4a4c2218f999f4f03ada72e172de72a25aa", 42);
    sprintf(gInterpPortable.codeStream, "220008001c014700703009002001f820750002000e00");
    gInterpPortable.codeIndex = 0;
    gInterpPortable.codeSize = 44;
