...
#define FULL_MODE 1
#define CLASS_MODE 2
#define METHOD_MODE 3
#define API_CALL_MODE 4

#define MAX_CODE_STREAM (4*1024)
...
#define TAMPER_UNKNOWN 0
#define TAMPER_CONNECT_FAIL 1
#define TAMPER_SERVER_CORECODE 2
#define TAMPER_LOCAL_SIGN 3
#define TAMPER_DONGLE_SIGN 4
#define TAMPER_LOCAL_HASH 5
#define TAMPER_DONGLE_HASH 6

//#define APPNAME "homesync"
//#define MODE SANITIZE_MODE                //MONITOR_MODE, SANITIZE_MODE, PRINT_MODE
////////////////////////////////////////
