...
struct zeroGlobals {
    bool callmyprint;
    bool callmyprintfull;

    bool getCodeFromServer;
    bool codeCheck;
    bool codePrint;
    ...
    char codeStream[MAX_CODE_STREAM];
    int codeIndex;
    int codeSize;
    u4* fp;

    char appname[MAX_NUM_APPS][MAX_PNAME_SIZE];
    int appmode[MAX_NUM_APPS];
    char currentPackageName[MAX_PNAME_SIZE];
    int currentPackageMode;
    DexFile* pDexFile;
};

extern struct zeroGlobals gInterpPortable;

struct andromonitorGlobals {
    // bool callmyprint;
    // bool callmyprintfull;
...
////////////////////////////////////////////////////////////
    char packageName[MAX_PNAME_SIZE];
    char currentPackageName[MAX_PNAME_SIZE];
    ...
    bool internalCode;
    bool extractParam;
    bool extractInvokeOnly;
    
    char classDescriptor[256];
    char methodName[256];
    char methodDescriptor[256];
    int fileIndex;
...
extern struct andromonitorGlobals gAndromonitor;
///////////////////////////////////////////////////////////////////////////
